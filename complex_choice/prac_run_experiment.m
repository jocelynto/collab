...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    DrawFormattedText(myscreen,'<<Press any response key to start>>','center','center',[255,255,255]);
    ...
    for trial_no=1:length(all_trial_code)
        ...
        if ismember(trial_no,new_block_trialno)
            ...
            DrawFormattedText(myscreen,'New round','center',y_center-50,[255,255,255]);
        ...
        while ~timedout
            ...
            if (keysecs-onset_time)>response_timeframe
                ...
                DrawFormattedText(myscreen,'Too Slow!','center','center',[255,255,255]);
        ...
        if trial_no==length(all_trial_code)/2
            DrawFormattedText(myscreen,'Resting','center','center',[255,255,255]);
            DrawFormattedText(myscreen,'<<Press any response key to resume>>','center',y_center+100,[255,255,255]);
            Screen('Flip',myscreen);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    Screen('Flip',myscreen);
    Screen('TextSize',myscreen,50);
    DrawFormattedText(myscreen,'End of experiment','center','center',[255,255,255]);
